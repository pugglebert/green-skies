...
public class Loader {
     ...
     */
    protected void checkFileType(String fileName) throws
            FileSystemException, IllegalArgumentException {
  ...
  /**
   * This method is the same as the loadFile method except it does not upload any data.
   * Checks if filename and datatype fields are empty. If they aren't, processes file by calling
   ...
   */
     ...
     * calling checkFileType, openFile and constructParser. If an error occurs while trying to open the
     * file, returns a message about the error. Otherwise, returns message abount number of rejected lines
     * from file.
     *
     * @param fileName Name of the file to be opened.
     * @param dataType The type of data in the file (one of airport, airline, or route).
