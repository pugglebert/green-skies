...
public class AnalyseController extends SideNavBarController implements Initializable {
  ...
  // TODO: is this class needed? HK
  /**
   * This method is used to run this class indivially.
   *
   * @param args
   */
  ...
  public void initialize(URL url, ResourceBundle resourceBundle) {
    //        System.out.println(Main.getStorage().getAirports()); //TODO remove! HK
    for (Airport airport : Main.getStorage().getAirports()) {
      airports.add(airport.getIATA());
    }
    //        System.out.println(airports); //TODO remove! HK
