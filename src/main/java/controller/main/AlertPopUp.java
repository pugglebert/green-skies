...
public class AlertPopUp {
    ...
    /**
     * This method displays a warning to the user when they are about to add routes to their history which contain
     * airports that are not present in the airport file.
    ...
    public static Optional<ButtonType> showAirportAlert(HashSet<String> invalidAirports) {
        ...
        StringBuilder headerText = new StringBuilder("Some of your selected routes contain airports that are not contained in the airport file.\n" +
