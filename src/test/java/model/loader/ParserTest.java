...
public class ParserTest {
    ...
    /**
     * Verify that erorCollectionInitializer does not change errorCollection when called with an integer
     * less than zero.
     */
    @Test
    ...
    /**
     * Verify that when errorCounter is called with an invalid number for the key, totalErrors remains the same.
     */
    @Test
    ...
    /**
     * Verify that when errorCounter is called with a valid key, the value corresponding to that key increases
     * by one.
     */
    @Test
    ...
    /**
     * Verify that when errorCounter is called with a valid key, all values which do not correspond to that key
     * remain unchanged.
     */
    @Test
    ...
    /**
     * Verify that getErrorMessage returns the correct message when no errors have been found in the file.
     */
    @Test
    ...
    /**
     * Verify that getErrorMessage returns the correct message when an error has been found in the file.
     */
